...
def get_args():
    ...
    parser.add_argument('--generate', action = 'store_true', default=False, help = 'point cloud generation or completion mode')
    parser.add_argument(
        '--resume', 
        action='store_true', 
        default=False, 
    ...
    if args.generate and args.ckpts is None:
        raise ValueError(
            'ckpts shouldnt be None while generation mode')
